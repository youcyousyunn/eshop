...
public class JsonUtils {
    ...
    /**
     * Title: Json2List<br/>
     * Description: json字符串转换成list<String>对象<br/>
     */
    ...
    @SuppressWarnings("unchecked")
    public static Map<String, Object> Josn2Map(String jsonStr) {
        Map<String, Object> map = new HashMap<String, Object>();
        if (!TextUtils.isEmpty(jsonStr)) {
    ...
    public static void main(String[] args) {
        String jsonStr = "[\"SHOP2016081111333501\", \"SHOP2016081111523004\", \"SHOP2016081113380407\", \"SHOP2016081113395210\", \"SHOP2016081113410113\"]";
        List<String> shoplst = JsonUtils.Json2List(jsonStr);
        List<String> test = new ArrayList<String>();
        test.add("1");
        test.add("3");
        System.out.println(JsonUtils.list2json(test));
        System.out.println(JsonUtils.Json2List("[\"1\", \"6\"]"));
    }
}
